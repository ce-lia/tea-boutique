...
ActiveRecord::Schema.define(version: 2021_04_22_135434) do
  ...
  create_table "shopping_sessions", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["client_id"], name: "index_shopping_sessions_on_client_id"
  end
  ...
  add_foreign_key "shopping_sessions", "clients"
end
